  ...
  return `<div id="create-agent-modal" class="modal" hx-on::click="if(event.target === this) this.remove()">
    <div class="modal-card">
      ...
      <div class="flex items-center justify-between">
        <button type="button" onclick="document.getElementById('create-agent-modal').remove()" class="btn btn-ghost">Close</button>
  ...
  return `<div id="create-agent-modal" class="modal" hx-on::click="if(event.target === this) this.remove()">
    <div class="modal-card">
      ...
      <form hx-post="/api/stacks/${stackId}/agents/tokens"
            ...
            hx-swap="innerHTML"
            hx-on::after-request="if(event.detail.successful) { const modal = document.getElementById('create-agent-modal'); if(modal) modal.remove(); }"
