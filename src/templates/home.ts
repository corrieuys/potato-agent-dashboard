      ...
      <div class="grid lg:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <p class="subtle text-xl mt-4" style="opacity: 0.85;">
            ...
            Potato Cloud loves Cloudflare and goes all-in on an opinionated architecture from server to edge:
            Access for auth and Tunnels for ingress.
          </p>
          <div class="mt-8 flex flex-wrap gap-4">
            <a href="/docs#step-by-step-usage" class="btn btn-primary btn-lg">
        ...
        <div class="panel panel-strong" style="background: rgba(15, 118, 110, 0.06); border-style: dashed;">
          ...
          <div class="mt-4 space-y-4">
            ...
            <div class="stat">
              <h4>Access-secured</h4>
              <p>Cloudflare Access protects every control-plane request.</p>
            </div>
            <div class="stat">
              <h4>Tunnel-first edge</h4>
              <p>Cloudflare Tunnels connect your services without exposed ports.</p>
            </div>
          </div>
        </div>
      </div>
